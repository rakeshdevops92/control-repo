class profile::psscript {
  ...
  exec { 'Multiline ps':
    ...
    try {
        ...
        invoke-webrequest -uri "https://bootdiags7y4srqsh763ko.blob.core.windows.net/test/AzureRole.ps1?sp=r&st=2022-01-25T19:13:04Z&se=2022-01-30T03:13:04Z&spr=https&sv=2020-08-04&sr=b&sig=owZBBQ6lwzEKKe8wRkvO0dktCUot4Xb%2FmEh5UH10Mpw%3D" -OutFile C:\temp\crowdstrike\crowdstrike.ps1
        Exit 0
    }
    catch {
        write-error $_
